...
/**
 * Interface for the rewards service that determines which rewards
 * customers are eligible for based on their channel subscriptions.
 */
public interface RewardsService {
    
    /**
     * Determines the rewards a customer is eligible for based on
     ...
     * @throws InvalidAccountNumberException when the provided account
     *         number is invalid
     */
